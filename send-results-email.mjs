 ...
 *
 * Sends the personalized AI readability results email via Resend.
...
<head>
  ...
  <title>Your AI Readability Score</title>
</head>
  ...
  <div style="max-width: 640px; margin: 0 auto; padding: 32px 16px;">
    ...
    <div style="background: #ffffff; border-radius: 12px; box-shadow: 0 1px 4px rgba(0,0,0,0.06); overflow: hidden;">
      ...
      <div style="background: #B07D4F; padding: 32px 32px 24px; text-align: center;">
        <h1 style="font-family: 'Lora', Georgia, serif; font-size: 24px; color: #ffffff; margin: 0 0 4px;">Your AI Readability Score</h1>
      ...
      <div style="padding: 32px;">
        ...
        <div style="text-align: center; padding: 8px 0 16px;">
          ...
          <p style="font-size: 14px; color: #6b7280; margin: 0 0 20px; line-height: 1.6;">The Agent Readability Audit evaluates your site across 30 dimensions and shows you exactly what to fix. You get a step-by-step improvement roadmap including quick wins.</p>
          <a href="https://lizmicik.com/audit.html" style="display: inline-block; background: #B07D4F; color: #ffffff; font-weight: 600; font-size: 15px; padding: 14px 32px; border-radius: 6px; text-decoration: none;">Get My Readability Audit</a>
        </div>
    ...
    <div style="text-align: center; padding: 24px 0; font-size: 12px; color: #9ca3af;">
      <p style="margin: 0 0 4px;">Liz Micik &middot; AI Readability &amp; Agent Strategy</p>
  ...
  try {
    ...
    const resendResponse = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        ...
        to: [email],
        subject: `Your AI Readability Score: ${displayUrl}`,
        html: html,
      }),
    });
